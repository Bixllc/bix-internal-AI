        ...
        {items.map((solution) => (
          <div key={solution.service} className="rounded-xl border border-border p-4">
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <p className="font-mono text-sm font-medium tabular-nums text-ink">{solution.estimatedPriceRange}</p>
            </div>
            <div className="mt-3 grid grid-cols-1 gap-3 lg:grid-cols-3">
              <div>
                <p className="text-xs font-medium text-faint">Why</p>
                <p className="mt-1 text-sm text-muted">{solution.whyItFits}</p>
              </div>
              <div>
                <p className="text-xs font-medium text-faint">Impact</p>
                <p className="mt-1 text-sm text-muted">{solution.expectedImpact}</p>
              </div>
              <div>
